...
module Sudoku
  RSpec.describe Game, "#solve" do
    it "solves the most trivial board with a single unknown number" do
      @game = Game.new
      # Each '0' is a blank cell
      @game.load_board 0, 3, 4, 9, 7, 6, 5, 8, 1,
                       9, 7, 1, 2, 8, 5, 3, 6, 4,
                       8, 5, 6, 4, 3, 1, 2, 9, 7,
                       6, 2, 9, 1, 4, 8, 7, 3, 5,
                       1, 8, 5, 3, 6, 7, 9, 4, 2,
    ...
    it "solves the board with multiple unknowns" do
      @game = Game.new
      # Each '0' is a blank cell
      @game.load_board 0, 3, 4, 9, 7, 6, 5, 8, 0,
                       9, 7, 1, 2, 8, 5, 3, 6, 4,
                       8, 5, 6, 4, 3, 1, 2, 9, 7,
                       6, 2, 9, 1, 4, 8, 7, 3, 5,
                       0, 8, 5, 3, 6, 7, 9, 4, 2,
